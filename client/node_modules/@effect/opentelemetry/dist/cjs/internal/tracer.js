...
const makeOtelSpan = (span, clock) => {
  ...
  const self = {
    ...
    isRecording: _Function.constTrue,
...
/** @internal */
const currentOtelSpan = exports.currentOtelSpan = /*#__PURE__*/Effect.clockWith(clock => Effect.map(Effect.currentSpan, span => {
...
/** @internal */
const layerTracer = exports.layerTracer = /*#__PURE__*/Layer.effect(Tracer, /*#__PURE__*/Effect.flatMap(/*#__PURE__*/Effect.zip(_Resource.Resource, TracerProvider), ([resource, provider]) => Effect.sync(() => provider.getTracer(resource.attributes[OtelSemConv.ATTR_SERVICE_NAME], resource.attributes[OtelSemConv.ATTR_SERVICE_VERSION]))));
/** @internal */
