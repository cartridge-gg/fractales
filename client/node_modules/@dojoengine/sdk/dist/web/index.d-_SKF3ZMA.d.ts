...
interface SDK<T extends SchemaType> {
     ...
     */
    subscribeTokenTransfer: (request: SubscribeTokenTransferRequest) => Promise<[torii.TokenTransfers, torii.Subscription]>;
    /**
     ...
     */
    getTokenTransfers(request: GetTokenTransferRequest): Promise<torii.TokenTransfers>;
    /**
     ...
     */
    onAchievementProgressionUpdated: (request: SubscribeAchievementProgressionRequest) => Promise<torii.Subscription>;
    /**
     ...
     * @returns {torii.Subscription} - Subscription handle
     */
    onTokenTransferUpdated: (request: SubscribeTokenTransferRequest) => Promise<torii.Subscription>;
    /**
...
declare const defaultTokenTransfer: torii.TokenTransfer;
 ...
 */
declare function getTokenTransfers(client: torii.ToriiClient, request: GetTokenTransferRequest): Promise<torii.TokenTransfers>;
/**
 * Subscribes to token balance updates
 *
 * # Parameters
 ...
 * @returns torii.Subscription
 */
declare function onTokenTransferUpdated(client: torii.ToriiClient, request: SubscribeTokenTransferRequest): Promise<torii.Subscription>;
/**
 ...
 * @returns {Promise<void>}
 */
declare function updateTokenTransferSubscription(client: torii.ToriiClient, request: UpdateTokenTransferSubscriptionRequest): Promise<void>;
/**
 ...
 * @returns {Promise<[torii.TokenTransfers, torii.Subscription]>}
 */
declare function subscribeTokenTransfer(client: torii.ToriiClient, request: SubscribeTokenTransferRequest): Promise<[torii.TokenTransfers, torii.Subscription]>;
...
export { type SubscribeResponse as $, type AchievementsPage as A, type MemberValueParam as B, ClauseBuilder as C, type MergedModels as D, NO_IDENTITY as E, NO_SIGNER as F, type GetParams as G, HashedKeysClause as H, Pagination as I, type ParsedEntity as J, KeysClause as K, type PlayerAchievementEntryData as L, MemberClause as M, NO_ACCOUNT as N, OrComposeClause as O, type PlayerAchievementsPage as P, type PlayerAchievementEntryView as Q, type PlayerAchievementProgressData as R, type SchemaType as S, type PlayerAchievementQueryInput as T, type PlayerAchievementStatsData as U, type SDKClientConfig as V, type SDKFunctionOptions as W, type SqlQueryIntegerValue as X, type SqlQueryValue as Y, type SubscribeAchievementProgressionRequest as Z, type SubscribeParams as _, type StandardizedQueryResult as a, type SubscribeTokenBalanceRequest as a0, type SubscribeTokenRequest as a1, type SubscribeTokenTransferRequest as a2, type SubscriptionCallback as a3, type SubscriptionCallbackArgs as a4, type TaskProgressData as a5, ToriiQueryBuilder as a6, type ToriiResponse as a7, UNDEFINED_CLAUSE as a8, type UnionOfModelData as a9, onTokenUpdated as aA, parseEntities as aB, parseTokenRequest as aC, safeCallback as aD, subscribeQueryModelCallback as aE, subscribeToken as aF, subscribeTokenBalance as aG, subscribeTokenTransfer as aH, toAchievementQuery as aI, toPlayerAchievementQuery as aJ, updateAchievementProgressionSubscription as aK, updateTokenBalanceSubscription as aL, updateTokenTransferSubscription as aM, type UpdateAchievementProgressionSubscriptionRequest as aa, type UpdateTokenBalanceSubscriptionRequest as ab, type UpdateTokenTransferSubscriptionRequest as ac, convertToPrimitive as ad, deepMerge as ae, defaultAchievementProgression as af, defaultToken as ag, defaultTokenBalance as ah, defaultTokenTransfer as ai, defaultToriiPagination as aj, generateTypedData as ak, getAchievements as al, getModel as am, getModelByEntityId as an, getPlayerAchievements as ao, getTokenBalances as ap, getTokenContracts as aq, getTokenTransfers as ar, getTokens as as, isCairoCustomEnum as at, isCairoOption as au, mergeCairoCustomEnum as av, mergeCairoOption as aw, onAchievementProgressionUpdated as ax, onTokenBalanceUpdated as ay, onTokenTransferUpdated as az, type SDKConfig as b, type AggregationsPage as c, type ActivitiesPage as d, type SqlQueryResponse as e, type SDK as f, type AchievementData as g, type AchievementProgressionData as h, type AchievementProgressionSubscriptionQuery as i, type AchievementProgressionView as j, type AchievementQueryInput as k, type AchievementTaskData as l, type ActivityEntry as m, type ActivityQueryInput as n, type ActivitySubscriptionQuery as o, type AggregationEntryView as p, type AggregationQueryInput as q, AndComposeClause as r, type AttributesFilter as s, type ContractType as t, type GetTokenBalanceRequest as u, type GetTokenContracts as v, type GetTokenRequest as w, type GetTokenTransferRequest as x, HistoricalToriiQueryBuilder as y, type HistoricalToriiQueryBuilderOptions as z };
