...
export const toriiclient_getAggregations: (a: number, b: any) => any;
export const toriiclient_getAchievements: (a: number, b: any) => any;
export const toriiclient_getPlayerAchievements: (a: number, b: any) => any;
export const toriiclient_getActivities: (a: number, b: any) => any;
...
export const toriiclient_onEntityUpdated: (a: number, b: number, c: number, d: number, e: any) => any;
export const toriiclient_updateEntitySubscription: (a: number, b: number, c: number, d: number, e: number) => any;
export const toriiclient_onEventMessageUpdated: (a: number, b: number, c: number, d: number, e: any) => any;
export const toriiclient_updateEventMessageSubscription: (a: number, b: number, c: number, d: number, e: number) => any;
...
export const toriiclient_onAggregationUpdated: (a: number, b: number, c: number, d: number, e: number, f: any) => any;
export const toriiclient_onActivityUpdated: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: any) => any;
...
export const toriiclient_updateAggregationSubscription: (a: number, b: number, c: number, d: number, e: number, f: number) => any;
export const toriiclient_onAchievementProgressionUpdated: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: any) => any;
export const toriiclient_updateAchievementProgressionSubscription: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => any;
export const toriiclient_updateActivitySubscription: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => any;
export const toriiclient_search: (a: number, b: any) => any;
...
export const wasm_bindgen__convert__closures_____invoke__hdbf7430e6569e36e: (a: number, b: number) => void;
export const closure1120_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h40fd58b8c8fdefef: (a: number, b: number) => void;
